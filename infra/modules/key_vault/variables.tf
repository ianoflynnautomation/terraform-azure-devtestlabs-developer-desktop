...
variable "key_permissions" {
  description = "(Optional) List of Key Permissions to assign to the current user/service principal."
  type        = list(string)
  default     = ["Get", "Create"]
}

variable "secret_permissions" {
  description = "(Optional) List of Secret Permissions to assign to the current user/service principal."
  type        = list(string)
